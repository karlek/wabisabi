...
func New(width, height int, iterations int64, method *coloring.Coloring, coef complex128, bailout float64, plane func(complex128, complex128) complex128, zoom, offsetReal, offsetImag float64, seed int64, points int64) *Fractal {
	r, g, b := histo.New(width, height), histo.New(width, height), histo.New(width, height)
	return &Fractal{Width: width, Height: height, Iterations: iterations, R: r, G: g, B: b, Method: method, Coef: coef, Bailout: bailout, Plane: plane, Zoom: zoom, OffsetReal: offsetReal, OffsetImag: offsetImag, Seed: seed, Points: points}
}
...
func NewStd() *Fractal {
	...
	return New(4096, 4096, 1e6, method, complex(1, 0), 4, zrzi, 1, 0.4, 0, 1, 80)
}
